    ...
    <footer class="pt-4 md-5  border-top">
      <div class="row">
        ...
        <div class="col-6 col-md">
          ...
          <ul class="list-unstyled text-small text-light">
            <li><a class="text-muted" href="#">va92999@gmail.com</a></li>
            <li><a class="text-muted" href="#">7355139363</a></li>
            <!-- <li><a class="text-muted" href="#">+20127865</a></li> -->
      ...
      <div class="border-top">
        <h6 class="text-center mt-3">Copyright ©2021 Vikramaditya Singh
        </h6>
        </div>
    </footer>
  </div>
